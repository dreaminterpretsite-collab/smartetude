...
const courseInfo: CourseInfo = {
  id: 'anglais-premiere-d',
  name: 'Anglais Première D',
  url: '/courses/anglais-premiere-d',
};
...
const units = [
  {
    ...
    lessons: [
      { title: 'Reading', pdfHref: 'https://drive.google.com/file/d/1g6B-KXpOXuK5W69dKgPeuSJsSIs9Jtkl/preview' },
      { title: 'Speaking', pdfHref: 'https://drive.google.com/file/d/14opuKlnwBjkOQIgf-jzNdgBKNkE1xm-3/preview' },
    ],
  },
  {
    title: 'UNIT 2: Natural resources',
    lessons: [
      { title: 'Listening', pdfHref: 'https://drive.google.com/file/d/1PNvLf1HNsya5jZK-zbqEc2bo9LONeYG1/preview' },
      { title: 'Reading', pdfHref: 'https://drive.google.com/file/d/1UCYo7iYmy4mUIBeOcqUtghRQv5_K0WHW/preview' },
    ],
  },
  {
    title: 'UNIT 3: Deadly Viruses and Diseases',
    lessons: [
      { title: 'Writing', pdfHref: 'https://drive.google.com/file/d/1cUFFUKZDRcdVSYFrbunv-e3wJlzAYDow/preview' },
      { title: 'Speaking', pdfHref: 'https://drive.google.com/file/d/1HJ3cutoXLKfA97NKrfj4Ly2uc2rW5MQu/preview' },
    ],
  },
  {
    title: 'UNIT 4: Crime and Violence',
    lessons: [
      { title: 'Reading', pdfHref: 'https://drive.google.com/file/d/1iGLcEg6P7LEf5pT0kuy_Xg-kHR0IRybC/preview' },
      { title: 'Speaking', pdfHref: 'https://drive.google.com/file/d/159EbOVnIBJItjMXdh1fM7nkm1FiP6Nr2/preview' },
    ],
  },
  {
    title: 'UNIT 5: Human Rights',
    lessons: [
        { title: 'Writing', pdfHref: 'https://drive.google.com/file/d/1idAddEdD-_Q3-qslFz6LD6yAxsTPNeEY/preview' },
        { title: 'Speaking', pdfHref: '#' },
    ],
  },
  {
    title: 'UNIT 6: Technology and our lives',
    lessons: [
        { title: 'Reading', pdfHref: 'https://drive.google.com/file/d/1h774Vs4nmPF_CRsZnifA3hiYMbC7vHSI/preview' },
        { title: 'Writing', pdfHref: 'https://drive.google.com/file/d/1f9kfqNb2ZPfq_NmsjKFSVxHAOSgUHAyc/preview' },
    ],
  },
  {
    title: 'UNIT 7: Political change',
    lessons: [
        { title: 'Reading', pdfHref: 'https://drive.google.com/file/d/10OsL-dyjqxzmjv-Zpd-Bv2-roa684RhE/preview' },
        { title: 'Speaking', pdfHref: 'https://drive.google.com/file/d/1e5kQ8UNwZdNJzqXDUTe15MzotfIhmLUV/preview' },
    ],
  },
    {
    title: 'UNIT 8: African Cultural Heritage',
    lessons: [
        { title: 'Listening', pdfHref: 'https://drive.google.com/file/d/1cRpocesBUXn7ofSgEBB-egSUQ4ISW9au/preview' },
        { title: 'Reading', pdfHref: 'https://drive.google.com/file/d/1-2tU-bwCQPG79RDn2qocTrleGoD9CiYn/preview' },
    ],
  },
];

export default function AnglaisPremiereDPage() {
