...
const courseInfo: CourseInfo = {
  id: 'histoire-geographie-terminale-d',
  name: 'Histoire-Géographie Terminale D',
  url: '/courses/histoire-geographie-terminale-d',
};
...
export default function HistoireGeographieTerminaleDPage() {
