...
const courseInfo: CourseInfo = {
  id: 'histoire-geographie-premiere-a',
  name: 'Histoire-Géographie Première A',
  url: '/courses/histoire-geographie-premiere-a',
};
...
export default function HistoireGeographiePremiereAPage() {
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <Card key={`geo-${index}`}>
                    ...
                    <CardContent className="flex flex-col space-y-2">
                      <Button variant="outline" disabled={!hasAccess} onClick={() => hasAccess ? openViewer(lesson.pdfHref, 'video') : handleLockedContent()}>
