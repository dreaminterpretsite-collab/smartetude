...
const courseInfo: CourseInfo = {
  ...
  name: 'Philosophie Terminale A',
  url: '/courses/philo-terminale-a',
};
...
const lessons = [
    ...
    { num: 4, title: 'LA VIE EN SOCIETE', pdfHref: 'https://drive.google.com/file/d/1o83cm1inT5F6nZWPIkiWSQhMgwJgRFRg/preview', videoHref: '#' },
    ...
    { num: 6, title: 'L’HISTOIRE ET L’HUMANITE', pdfHref: 'https://drive.google.com/file/d/1m8jhTttBj_kBQyl-rByztvs66EU-CAYq/preview', videoHref: '#' },
    ...
    { num: 8, title: 'PROGRES ET BONHEUR', pdfHref: 'https://drive.google.com/file/d/1eC1CyI5UEAkMQ8ddp4KLtPC4OPG12-TE/preview', videoHref: 'https://drive.google.com/file/d/1FVc3jeWTksDnCtFsFllWNHNlzSvM6bTF/preview' },
    { num: 9, title: 'LANGAGE ET VERITE', pdfHref: 'https://drive.google.com/file/d/18USFbHlu1T4IjV60X8ensyXVkxiOR6Rg/preview', videoHref: 'https://drive.google.com/file/d/1BtHnnf07nBdnovgfsSXf6DkddrTsqYgk/preview' },
...
export default function PhiloTerminaleAPage() {
