...
const courseInfo: CourseInfo = {
  id: 'anglais-terminale-a',
  name: 'Anglais Terminale A',
  url: '/courses/anglais-terminale-a',
};
...
const units = [
  ...
  {
    title: 'UNIT 7: Bribery, corruption and International issues',
    lessons: [
        { title: 'Bribery and corruption - Reading', videoHref: 'https://drive.google.com/file/d/1AHew15GAn8noJaoForFDMZY2WKnQAylG/preview', pdfHref: '#' },
        { title: 'International issues - Reading', videoHref: '#', pdfHref: 'https://drive.google.com/file/d/1p3safdrim0fMPuKtbGqTrAVBfiOyuqVr/preview' },
        { title: 'International issues - Writing', videoHref: '#', pdfHref: 'https://drive.google.com/file/d/1YMC01RtW1bdOuUg3XW-xX16aWRyZMGFN/preview' },
    ],
  },
    {
    title: 'UNIT 8: Across Cultures',
    lessons: [
...
export default function AnglaisTerminaleAPage() {
