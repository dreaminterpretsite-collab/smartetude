...
const courseInfo: CourseInfo = {
  id: 'histoire-geographie-terminale-a',
  name: 'Histoire-Géographie Terminale A',
  url: '/courses/histoire-geographie-terminale-a',
};
...
export default function HistoireGeographieTerminaleAPage() {
