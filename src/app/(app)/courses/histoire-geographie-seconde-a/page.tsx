...
const courseInfo: CourseInfo = {
  id: 'histoire-geographie-seconde-a',
  name: 'Histoire-Géographie Seconde A',
  url: '/courses/histoire-geographie-seconde-a',
};
...
export default function HistoireGeographieSecondeAPage() {
                ...
                <Card key={`geo-${index}`}>
                    ...
                    <CardTitle className="text-lg flex items-center gap-2">
                       {hasAccess ? (
                        ...
                        <span><span className="font-bold text-accent">{lesson.title}</span></span>
                    </CardTitle>
                    </CardHeader>
